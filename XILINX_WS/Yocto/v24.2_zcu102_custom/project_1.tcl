...
#
# Generated by Vivado on Fri Feb 21 09:46:44 JST 2025
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.704152",
   "Default View_TopLeft":"11,-315",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port dip_switches_8bits -pg 1 -lvl 5 -x 1560 -y 110 -defaultsOSRD
preplace port led_8bits -pg 1 -lvl 5 -x 1560 -y 250 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 230 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 4 -x 1430 -y 110 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 4 -x 1430 -y 250 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 3 -x 1160 -y 220 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 2 -x 830 -y 100 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 4 20 320 640 220 1010 300 1310
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 1 1 650 80n
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 2 2 1020 140 1320
preplace netloc axi_gpio_0_GPIO 1 4 1 N 110
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 2 NJ 210 1010
preplace netloc axi_smc_M00_AXI 1 3 1 1300 90n
preplace netloc axi_gpio_1_GPIO 1 4 1 N 250
preplace netloc axi_smc_M01_AXI 1 3 1 N 230
levelinfo -pg 1 0 330 830 1160 1430 1560
pagesize -pg 1 -db -bbox -sgen 0 0 1750 330
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project_1/project_1.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu9eg-ffvb1156-2-e -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu9eg-ffvb1156-2-e -flow {Vivado Implementation 2024} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
