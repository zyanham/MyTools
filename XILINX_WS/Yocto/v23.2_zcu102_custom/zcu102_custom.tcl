...
#
# zcu102_custom.tcl: Tcl script for re-creating project 'zcu102_custom'
#
# Generated by Vivado on Thu Feb 20 18:02:07 JST 2025
...
#
# 1. This project restoration tcl script (zcu102_custom.tcl) that was generated.
#
...
set _xil_proj_name_ "zcu102_custom"
...
set script_file "zcu102_custom.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/zcu102_custom"]"
...
\
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S01_ACLK]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.693948",
   "Default View_TopLeft":"10,-81",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port dip_switches_8bits -pg 1 -lvl 4 -x 1280 -y 80 -defaultsOSRD
preplace port led_8bits -pg 1 -lvl 4 -x 1280 -y 220 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 110 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 1150 -y 80 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 3 -x 1150 -y 220 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 840 -y 190 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 2 -x 840 -y 440 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 200 650 20 1020
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 1 1 640 120n
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 1 2 660 10 1030
preplace netloc axi_gpio_0_GPIO 1 3 1 NJ 80
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 NJ 80
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 1040J 60n
preplace netloc axi_gpio_1_GPIO 1 3 1 NJ 220
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 1 NJ 200
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N 100
levelinfo -pg 1 0 330 840 1150 1280
pagesize -pg 1 -db -bbox -sgen 0 0 1470 540
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zcu102_custom/zcu102_custom.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zcu102_custom.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/zcu102_custom.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zcu102_custom.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
