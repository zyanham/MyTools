...
#
# vek280_custom.tcl: Tcl script for re-creating project 'vek280_custom'
#
# Generated by Vivado on Mon Mar 03 17:06:48 JST 2025
...
#
# 1. This project restoration tcl script (vek280_custom.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/shinko/MyTools/XILINX_WS/Yocto/v24.2_vek280_custom_try/vek280_custom/vek280_custom.srcs/sources_1/new/LED_Chika.v"
#    "/home/shinko/MyTools/XILINX_WS/Yocto/v24.2_vek280_custom_try/vek280_custom/vek280_custom.srcs/constrs_1/new/vek280.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vek280_custom/vek280_custom.srcs/sources_1/new/LED_Chika.v"]"\
 "[file normalize "$origin_dir/vek280_custom/vek280_custom.srcs/constrs_1/new/vek280.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "vek280_custom"
...
set script_file "vek280_custom.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/vek280_custom"]"
...
set file "[file normalize "$origin_dir/vek280_custom/vek280_custom.srcs/constrs_1/new/vek280.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/vek280.xdc"
...
if { [get_files [list LED_Chika.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/shinko/MyTools/XILINX_WS/Yocto/v24.2_vek280_custom_try/vek280_custom/vek280_custom.srcs/sources_1/new/LED_Chika.v
}
...
{PMC_MIO 26 .. 36}}} \
  ...
  set_property -dict [ list \
   CONFIG.REGION {0} \
   CONFIG.CONNECTIONS {MC_3 {read_bw {100} write_bw {100} read_avg_burst {4} write_avg_burst {4}} M00_AXI {read_bw {5} write_bw {5}} M01_AXI {read_bw {5} write_bw {5}}} \
   CONFIG.DEST_IDS {M00_AXI:0x0:M01_AXI:0x40} \
   CONFIG.NOC_PARAMS {} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports gpio_dp] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports gpio_led] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_net -net LED_Chika_0_led  [get_bd_pins LED_Chika_0/led] \
  [get_bd_ports led]
  connect_bd_net -net rst_versal_cips_0_333M_peripheral_aresetn  [get_bd_pins rst_versal_cips_0_333M/peripheral_aresetn] \
  [get_bd_pins axi_gpio_0/s_axi_aresetn] \
  [get_bd_pins axi_gpio_0_smc/aresetn] \
  [get_bd_pins axi_gpio_1/s_axi_aresetn] \
  [get_bd_pins axi_gpio_1_smc/aresetn] \
  [get_bd_pins LED_Chika_0/rst]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_1] [get_bd_addr_segs axi_noc_0/S01_AXI/C2_DDR_LOW0x2] -force
  assign_bd_address -offset 0x000800000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces versal_cips_0/FPD_CCI_NOC_1] [get_bd_addr_segs axi_noc_0/S01_AXI/C2_DDR_LOW1x2] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.482922",
   "Default View_TopLeft":"-300,2",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port ch0_lpddr4_trip1 -pg 1 -lvl 6 -x 1760 -y 550 -defaultsOSRD
preplace port ch1_lpddr4_trip1 -pg 1 -lvl 6 -x 1760 -y 570 -defaultsOSRD
preplace port lpddr4_clk1 -pg 1 -lvl 0 -x -40 -y 330 -defaultsOSRD
preplace port ch0_lpddr4_trip2 -pg 1 -lvl 6 -x 1760 -y 590 -defaultsOSRD
preplace port ch1_lpddr4_trip2 -pg 1 -lvl 6 -x 1760 -y 610 -defaultsOSRD
preplace port lpddr4_clk2 -pg 1 -lvl 0 -x -40 -y 350 -defaultsOSRD
preplace port gpio_dp -pg 1 -lvl 6 -x 1760 -y 340 -defaultsOSRD
preplace port gpio_led -pg 1 -lvl 6 -x 1760 -y 160 -defaultsOSRD
preplace port port-id_led -pg 1 -lvl 6 -x 1760 -y 990 -defaultsOSRD
preplace inst LED_Chika_0 -pg 1 -lvl 4 -x 1220 -y 990 -defaultsOSRD
preplace inst versal_cips_0 -pg 1 -lvl 3 -x 770 -y 570 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 2 -x 390 -y 440 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 1 -x 120 -y 440 -defaultsOSRD
preplace inst axi_noc_0 -pg 1 -lvl 4 -x 1220 -y 560 -defaultsOSRD
preplace inst axi_gpio_0_smc -pg 1 -lvl 5 -x 1580 -y 240 -defaultsOSRD
preplace inst rst_versal_cips_0_333M -pg 1 -lvl 4 -x 1220 -y 840 -defaultsOSRD
preplace inst axi_gpio_1_smc -pg 1 -lvl 5 -x 1580 -y 80 -defaultsOSRD
preplace netloc versal_cips_0_fpd_cci_noc_axi0_clk 1 3 1 1040 580n
preplace netloc versal_cips_0_fpd_cci_noc_axi1_clk 1 3 1 1040 600n
preplace netloc versal_cips_0_fpd_cci_noc_axi2_clk 1 3 1 1040 620n
preplace netloc versal_cips_0_fpd_cci_noc_axi3_clk 1 3 1 1040 640n
preplace netloc versal_cips_0_lpd_axi_noc_clk 1 3 1 1040 660n
preplace netloc versal_cips_0_pmc_axi_noc_axi0_clk 1 3 1 1040 680n
preplace netloc versal_cips_0_pl0_ref_clk 1 0 5 10 520 260 310 N 310 1030 310 1410
preplace netloc rst_versal_cips_0_333M_peripheral_aresetn 1 0 5 0 360 270 360 N 360 1000 360 1440
preplace netloc LED_Chika_0_led 1 4 2 NJ 990 NJ
preplace netloc versal_cips_0_pl0_resetn 1 3 1 970 570n
preplace netloc versal_cips_0_FPD_CCI_NOC_0 1 3 1 970 420n
preplace netloc versal_cips_0_FPD_CCI_NOC_1 1 3 1 970 440n
preplace netloc versal_cips_0_FPD_CCI_NOC_2 1 3 1 970 460n
preplace netloc versal_cips_0_FPD_CCI_NOC_3 1 3 1 970 480n
preplace netloc versal_cips_0_LPD_AXI_NOC_0 1 3 1 970 500n
preplace netloc versal_cips_0_PMC_NOC_AXI_0 1 3 1 1010 520n
preplace netloc axi_noc_0_CH0_LPDDR4_0 1 4 2 NJ 550 N
preplace netloc axi_noc_0_CH1_LPDDR4_0 1 4 2 NJ 570 N
preplace netloc lpddr4_clk1_1 1 0 4 NJ 330 NJ 330 510 350 1040J
preplace netloc axi_noc_0_CH0_LPDDR4_1 1 4 2 NJ 590 N
preplace netloc axi_noc_0_CH1_LPDDR4_1 1 4 2 NJ 610 N
preplace netloc lpddr4_clk2_1 1 0 4 NJ 350 NJ 350 500 370 1020J
preplace netloc axi_gpio_0_GPIO 1 2 4 530 330 N 330 N 330 1740J
preplace netloc axi_gpio_0_smc_M00_AXI 1 1 5 280 160 N 160 N 160 NJ 160 1720
preplace netloc axi_noc_0_M00_AXI 1 4 1 1430 220n
preplace netloc axi_gpio_1_GPIO 1 1 5 230J 520 520 320 NJ 320 NJ 320 1740J
preplace netloc axi_gpio_1_smc_M00_AXI 1 0 6 10 320 NJ 320 500 340 NJ 340 NJ 340 1730
preplace netloc axi_noc_0_M01_AXI 1 4 1 1420 60n
levelinfo -pg 1 -40 120 390 770 1220 1580 1760
pagesize -pg 1 -db -bbox -sgen -180 0 1930 1060
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vek280_custom/vek280_custom.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
