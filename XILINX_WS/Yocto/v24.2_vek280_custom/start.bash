...
cat << EOF > ../sources/meta-myhardware/conf/machine/myhardware-vek280-versal.conf 
...
sed -i "/MACHINE ??=/c\MACHINE ??= \"myhardware-vek280-versal\"" conf/local.conf # Set the machine in conf/local.conf (change name as applicable)

# SD Card Image
echo 'IMAGE_FSTYPES += "wic"' >>  ../sources/meta-myhardware/conf/machine/myhardware-vek280-versal.conf # Change path to match your machine layer
