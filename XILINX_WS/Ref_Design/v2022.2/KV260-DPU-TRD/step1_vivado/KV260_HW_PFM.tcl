...
#
# KV260_HW_PFM.tcl: Tcl script for re-creating project 'KV260_HW_PFM'
#
# Generated by Vivado on Thu Jan 11 09:18:20 JST 2024
...
#
# 1. This project restoration tcl script (KV260_HW_PFM.tcl) that was generated.
#
...
set _xil_proj_name_ "KV260_HW_PFM"
...
set script_file "KV260_HW_PFM.tcl"
...
set_property -name "platform.name" -value "KV260_HW_PFM" -objects $obj
...
\
  ...
  set_property PFM_NAME {xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:KV260_HW_PFM:0.0} [get_files [current_bd_design].bd]
  set_property PFM.IRQ {intr { id 0 range 32 }} [get_bd_cells /axi_intc_0]
  set_property PFM.CLOCK {clk_out1 {id "0" is_default "false" proc_sys_reset "/proc_sys_reset_0" status "fixed" freq_hz "100000000"} clk_out2 {id "1" is_default "true" proc_sys_reset "/proc_sys_reset_1" status "fixed" freq_hz "200000000"} clk_out3 {id "2" is_default "false" proc_sys_reset "/proc_sys_reset_2" status "fixed" freq_hz "400000000"}} [get_bd_cells /clk_wiz_0]
...
set_property PFM_NAME "xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:KV260_HW_PFM:0.0" [get_files system.bd ] 
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/KV260_HW_PFM.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/KV260_HW_PFM.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/KV260_HW_PFM.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/KV260_HW_PFM.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
...
set_property pfm_name {xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:KV260_HW_PFM:0.0} [get_files -all {/home/meowth/Desktop/KV260_TRD/01_Vivado/KV260_HW_PFM.srcs/sources_1/bd/system/system.bd}]
set_property platform.uses_pr {false} [current_project]
write_hw_platform -include_bit -force -file /home/meowth/Desktop/KV260_TRD/01_Vivado/KV260_HW_PFM.xsa
