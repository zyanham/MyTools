...
set_property -name "platform.name" -value "prj" -objects $obj
...
\
  ...
  set_property PFM_NAME {xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:prj:0.0} [get_files [current_bd_design].bd]
...
set_property PFM_NAME "xilinx:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:prj:0.0" [get_files system.bd ] 
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/prj.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/prj.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/prj.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/prj.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
