...
#
# vek280_wDDR2ch.tcl: Tcl script for re-creating project 'vek280_wDDR2ch'
#
# Generated by Vivado on Tue Mar 04 10:07:16 JST 2025
...
#
# 1. This project restoration tcl script (vek280_wDDR2ch.tcl) that was generated.
#
...
set _xil_proj_name_ "vek280_wDDR2ch"
...
set script_file "vek280_wDDR2ch.tcl"
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vek280_wDDR2ch.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
