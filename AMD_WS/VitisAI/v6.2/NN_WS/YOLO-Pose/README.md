...
```bash
CALIB_DIR=../Dataset/HumanFaces bash 07_quark_int8.bash
bash 08_compile_int8.bash
bash 09_run_npu_int8.bash ../Dataset/HumanFaces results/npu_yolo_pose_int8
```

Outputs and cache key:

- `models/yolo_pose_vint8.onnx`, cache key `yolo_pose_vint8`

AI Analyzer:

```bash
bash 10_run_npu_int8_ai_analyzer.bash ../Dataset/HumanFaces results/npu_yolo_pose_int8_analyzer
```
