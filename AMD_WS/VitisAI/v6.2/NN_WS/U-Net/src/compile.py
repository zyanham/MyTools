...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compile U-Net ONNX model for Vitis AI VAIML.")
    parser.add_argument("--model_path", default="models/unet.onnx", help="Path to the ONNX model.")
    parser.add_argument("--cache_dir", default="my_cache_dir", help="Directory to store compiled cache files.")
    parser.add_argument("--cache_key", default="carvana_unet_fp32_bf16", help="Cache key for the compiled model.")
    ...
    print("=" * 70)
    print("U-Net Vitis AI Model Compilation")
    print("=" * 70)
