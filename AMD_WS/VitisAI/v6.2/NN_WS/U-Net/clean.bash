...
if [[ ! -f "$ROOT/vitisai_config.json" || ! -f "$ROOT/src/infer_file2file.py" || ! -f "$ROOT/src/export_carvana_onnx.py" ]]; then
  echo "Refusing to clean unexpected directory without Carvana U-Net workspace markers: $ROOT" >&2
  exit 2
fi
...
echo "Cleaning generated U-Net artifacts under: $ROOT"
