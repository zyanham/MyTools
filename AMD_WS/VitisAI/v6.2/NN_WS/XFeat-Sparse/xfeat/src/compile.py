...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compile an ONNX model for Vitis AI VAIML.")
    parser.add_argument("--model_path", required=True, help="Path to the ONNX model.")
    parser.add_argument("--cache_dir", default="my_cache_dir", help="Directory to store compiled cache files.")
    parser.add_argument("--cache_key", required=True, help="Cache key for the compiled model.")
    ...
    print("=" * 70)
    print("XFeat Sparse Vitis AI Model Compilation")
    print("=" * 70)
