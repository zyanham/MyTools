...
ensure_model_file "models/yolov8m.onnx" "Run bash 02_export.bash first."
if [[ ! -d calib_data ]]; then
    echo "Missing calib_data directory. Prepare calibration images before running Quark." >&2
    exit 1
fi
run_logged "$LOG_DIR/quark.log" "$PYTHON_BIN" src/quantize.py
