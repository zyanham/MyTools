...
RUN_LOG="${RUN_LOG:-$LOG_DIR/npu_run_resnet50cpp_python.log}"

ensure_model_file "models/resnet50-v1-12.onnx" "Run bash 01_setup.bash first, or place the ONNX file in models/."
