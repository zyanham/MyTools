...
if [[ -f models/resnet50-v1-12.onnx ]]; then
    mkdir -p "$LOG_DIR"
    echo "models/resnet50-v1-12.onnx already exists; setup skipped." | tee "$LOG_DIR/setup.log"
else
    run_logged "$LOG_DIR/setup.log" download_file "$MODEL_URL" models/resnet50-v1-12.onnx
fi
